    ...
    9636: function (e, t, n) {
      ...
      t.default = function () {
        var e,
          ...
          n = t.auth,
          o = t.authDispatch,
          N = (0, k.ZP)("/users/hasSuperAdmin", w.Z).data,
          S = (0, k.ZP)("/app-config", w.Z).data,
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (e.prev = 1),
                            (e.next = 4),
                            b.Z.post("/auth/login", { email: n, password: r })
                          );
                        case 4:
                          (s = e.sent),
                            (i = s.data),
                            o({ type: "LOGIN", payload: i.data.accessToken }),
                            (c = { ue: n, up: r }),
                            a
        ...
        return null !== N &&
          void 0 !== N &&
          N.hasSuperAdmin &&
          (n.user || (null !== N && void 0 !== N && N.hasSuperAdmin))
          ? null !== (e = n.user) &&
            void 0 !== e &&
            e.role &&
            O &&
            !O.data.find(function (e) {
              return e.role === n.user.role || "user" === n.user.role;
            })
            ? (y.Am.error("Only authorized users can have access!"),
    ...
    2014: function (e, t, n) {
      ...
      var r = n(4942),
        ...
        b = function (e, t) {
            ...
            o.useEffect(
              function () {
                if (!k)
                  return (
                    w.value !== S.current &&
                      (null === N || void 0 === N || N.cancelValue(S.current),
                      null === N || void 0 === N || N.registerValue(w.value),
                      (S.current = w.value)),
                    function () {
          ...
          var _ = s()(
              ((n = {}),
              (0, r.Z)(n, "".concat(O, "-wrapper"), !0),
              (0, r.Z)(n, "".concat(O, "-rtl"), "rtl" === C),
              (0, r.Z)(n, "".concat(O, "-wrapper-checked"), E.checked),
              (0, r.Z)(n, "".concat(O, "-wrapper-disabled"), E.disabled),
              n),
              c
            ),
            I = s()((0, r.Z)({}, "".concat(O, "-indeterminate"), f));
          return o.createElement(
            "label",
            { className: _, style: h, onMouseEnter: v, onMouseLeave: x },
            o.createElement(
              i.Z,
              (0, a.Z)({}, E, { prefixCls: O, className: I, ref: t })
            ),
        ...
        O = (0, u.memo)(function (e) {
          ...
          return (
            ...
            (0, u.useEffect)(function () {
              n === 1 / 0
                ? m.apply(void 0, [l.current].concat(S(t), [m]))
                : "number" === typeof n
                ? m.apply(
                    void 0,
                    [l.current].concat(S(Array(n).fill(t).flat()))
                  )
                : m.apply(void 0, [l.current].concat(S(t)));
            }),
...
//# sourceMappingURL=636.750c2b0f.chunk.js.map
