    ...
    7545: function (e, t, a) {
      ...
      t.default = function (e) {
        var t,
          ...
          Y = U[0],
          J = U[1],
          K = (0, l.useState)({ status: "", statusText: "", time: "0 ms" }),
          X = (0, n.Z)(K, 2),
          $ = X[0],
          ee = X[1],
          te = {
        ...
        var ae = (0, l.useCallback)(function (e) {
          z(e);
        }, []);
        (0, l.useEffect)(
          function () {
        ...
        var re = (function () {
                            ...
                            (0, m.Z)({
                              ...
                              url:
                                ...
                                (0 !== Object.keys(Y).length
                                  ? "/".concat(Object.values(Y))
                                  : ""),
                              headers: G,
                              params: I,
                              data:
                                a.body.isRequired && Object.keys(N).length > 0
                                  ? N
                                  : a.body.params,
                              timeout: 4e3,
                            })
          ...
          se = {
            ...
            url:
              c.T +
              a.url.path +
              (0 !== Object.keys(Y).length ? "/".concat(Object.values(Y)) : ""),
          };
        return (0, x.jsxs)("div", {
          className: "my-4",
          children: [
            (0, x.jsxs)("button", {
              onClick: function () {
                p(!y), 0 !== Object.keys(D).length && D.length >= 50 && ae({});
              },
            ...
            y &&
              (0, x.jsxs)("div", {
                ...
                children: [
                  (0, x.jsxs)("h1", {
                    className: "font-ubuntu my-3 text-lg dark:text-white flex",
                    children: [
                      (0, x.jsx)("span", {
                        className: " ".concat(
                          "GET" === a.method
                  ...
                  (0, x.jsx)("div", {
                    className:
                      "font-ubuntu mb-5 rounded-md bg-gray-100 p-5 text-lg font-normal dark:bg-gray-800 dark:text-white",
                  ...
                  (0, x.jsx)("div", {
                    className: "my-4",
                    children:
                      a.headers.isRequired && "headers" === k
                        ? (0, x.jsx)(l.Suspense, {
                            fallback: (0, x.jsx)(o.Z, {}),
                            children: (0, x.jsx)(b, {
                              src: G,
