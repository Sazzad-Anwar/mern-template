    ...
    9636: function (e, t, n) {
      ...
      t.default = function () {
        var e,
          ...
          a = n.auth,
          j = n.authDispatch,
          C = (0, y.ZP)("/users/hasSuperAdmin", b.Z).data,
          N = (0, y.ZP)("/roles", b.Z).data,
          O = (function () {
            var e = (0, r.Z)(
              o().mark(function e(t) {
                var n, r, a, s, l, i, c, u;
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (e.prev = 1),
                            (e.next = 4),
                            g.Z.post("/auth/login", { email: n, password: r })
                          );
                        case 4:
                          (s = e.sent),
                            (l = s.data),
                            j({ type: "LOGIN", payload: l.data.accessToken }),
                            (i = { ue: n, up: r }),
                            console.log(i),
                            a
                              ...
                              : (localStorage.removeItem("__uc"),
                                localStorage.removeItem("remember", a)),
                            (e.next = 15);
                          break;
                        case 12:
                          (e.prev = 12),
                            ...
                            x.Am.error(
                              null !==
                                (c =
                                  null === (u = e.t0.response) || void 0 === u
                                    ? void 0
                                    : u.data.message) && void 0 !== c
                                ? c
                                : e.t0.message
                            );
                        case 15:
        ...
        return a.user || (null !== C && void 0 !== C && C.hasSuperAdmin)
          ? a.user &&
            N &&
            !N.data.find(function (e) {
              return e.role === a.user.role;
            })
            ? (x.Am.error("Only admins and super admins can have access!"),
              (0, Z.jsx)(m.Fg, { to: "/login" }))
            : a.user
            ? (0, Z.jsx)(m.Fg, { to: "/" })
            : (0, Z.jsxs)(Z.Fragment, {
                children: [
                  (0, Z.jsx)("div", {
                    ...
                    children: (0, Z.jsx)(k.Z, { hideButton: !0 }),
                  }),
                  (0, Z.jsxs)("div", {
                    className:
                            ...
                            (0, Z.jsxs)(s.Z, {
                              ...
                              children: [
                                ...
                                (0, Z.jsx)(s.Z.Item, {
                                  ...
                                  children: (0, Z.jsx)(l.Z.Password, {
                                    type: "password",
                                    size: "large",
                                    prefix: (0, Z.jsx)(f.o1l, { size: 25 }),
      ...
      var r = n(4942),
        ...
        h = function (e, t) {
          ...
          var B = {
            ...
            V = l()(K, (0, r.Z)({}, "".concat(K, "-rtl"), "rtl" === j), x);
          return o.createElement(
            "div",
            (0, a.Z)({ className: V, style: g }, T, { ref: t }),
            o.createElement(m.Provider, { value: B }, s)
          );
        },
        v = o.forwardRef(h),
        x = o.memo(v),
        ...
        b = function (e, t) {
          ...
          var _ = l()(
            ...
            I = l()((0, r.Z)({}, "".concat(S, "-indeterminate"), p));
          return o.createElement(
            "label",
              ...
              [
                {
                  ...
                  value: function (e, t) {
                    return "checked" in e
                      ? (0, s.Z)((0, s.Z)({}, t), {}, { checked: e.checked })
                      : null;
                  },
                },
              ]
            ...
            switch ((l.prev = l.next)) {
              case 0:
                (t = (0, a.Z)(e)),
                  ...
                  (o = s.length > 2 && void 0 !== s[2] ? s[2] : n.length);
              case 3:
                if (!(r < o)) {
                  l.next = 8;
                  break;
          ...
          for (;;)
            switch ((l.prev = l.next)) {
              ...
              case 3:
                ...
                return (l.next = 6), n.slice(0, --o).join("");
              case 6:
                l.next = 3;
                break;
              case 8:
        ...
        S = (0, u.memo)(function (e) {
          ...
          return (
            ...
            (0, u.useEffect)(function () {
              n === 1 / 0
                ? m.apply(void 0, [s.current].concat(O(t), [m]))
                : "number" === typeof n
                ? m.apply(
                    void 0,
                    [s.current].concat(O(Array(n).fill(t).flat()))
                  )
                : m.apply(void 0, [s.current].concat(O(t)));
            }),
            u.createElement(l, { ref: s, className: i.join(" ") })
          );
        });
    },
  },
]);
//# sourceMappingURL=636.5738aec0.chunk.js.map
