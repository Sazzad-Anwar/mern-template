        ...
        <div style="max-width: 600px;background-color: #fafdfe;box-shadow: 0 0 10px rgba(0, 0, 0, .2);">
            ...
            <table align="center"
                ...
                <tr>
                    <td style="padding: 0;">
                        <table width="100%" style="border-spacing: 0;" role="presentation">
                            ...
                            <tr>
                                <td height="3"
                                    style="background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(121,9,58,1) 35%, rgba(0,212,255,1) 100%);">
                                </td>
                            </tr>
                            <tr>
                                <td
                                    style="background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(121,9,58,1) 35%, rgba(0,212,255,1) 100%);text-align: center;padding: 20px 0 20px 0;">
                                    <a href="https://example.com" target="_blank">
                                        <img style="box-shadow: 0 0 10px rgba(0, 0, 0, .3);border-radius: 50%;"
                                            src="${process.env.APP_URL}/logo512.png" alt="medi-career"
                                            title="medi-career" width="auto" height="150px" border="0" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td style="padding: 0;">
                        <table width="100%" style="border-spacing: 0; background-color: #fafdfe;" role="presentation">
                            ...
                            <tr>
                                <td style="padding: 0px 30px 10px 50px;text-align: left;">
                                    <a href="${resetLink}"
                                        style="background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(121,9,58,1) 35%, rgba(0,212,255,1) 100%);padding: .5rem 1rem;color:#ffff;text-decoration: none;border-radius: 5px;">Open
                                        Request</a>
                                </td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td style="padding: 0;">
                        <table width="100%"
                            style="border-spacing: 0;background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(121,9,58,1) 35%, rgba(0,212,255,1) 100%);"
                            role="presentation">
                            <tr style="color:#fff;">

                                <td class="footer"
                                    style="text-align: center;margin: 1rem;padding:1rem;font-size: 16px;width: 300px;">
                                    <a href="https://example.com" target="_blank">
                                        <img style="box-shadow: 0 0 10px rgba(0, 0, 0, .3);border-radius: 50%;"
                                            src="${process.env.APP_URL}/logo512.png" alt="medi-career"
                                            title="medi-career" width="auto" height="50px" border="0" />
                                    </a>
                                </td>

                                <td class="footer"
                                    style="text-align: center;margin: 1rem;padding:1rem;font-size: 16px;width: 300px;">
                                    <h3 style="margin-bottom: 0px;font-weight: bolder;">Medi Career</h3>
                                    <a href="#">www.medicareer.com</a>
                                </td>

                                <td class="footer"
                                    style="text-align: center;padding:1rem;margin: 1rem;font-size: 16px;width: 300px;">
                                    <table>
                                        <tr>
                                            <td style="width: 100px;text-align: center">
                                                <a href="https://facebook.com" target="_blank">
                                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Facebook_f_logo_%282019%29.svg/100px-Facebook_f_logo_%282019%29.svg.png"
                                                        alt="facebook"
                                                        style="box-shadow: 0 0 10px rgba(0, 0, 0, .3);border-radius: 50%;padding: 5px;"
                                                        height="25px">
                                                </a>
                                            </td>
                                            <td style="width: 100px;text-align: center">
                                            ...
                                            <td style="width: 100px;text-align: center">
                                                <a href="https://twitter.com" target="_blank">
                                                    <img src="//upload.wikimedia.org/wikipedia/commons/4/4f/Twitter-logo.svg"
                                                        alt="twitter"
                                                        style="box-shadow: 0 0 10px rgba(0, 0, 0, .3);border-radius: 50%;padding: 5px;"
                                                        height="25px">
                                                </a>
